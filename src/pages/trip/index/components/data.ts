const categoryTabs = ['종합', 'IT', '연예', '스포츠'];

const newsData = [
  {
    tabs: '종합',
    title: '아폴로17, 월면 활동 개시',
    description: '아폴로 17호는 1972년 12월 7일 미국 미국항공우주국(NASA)에 의해 발사된 유인 우주선이다.',
  },
  {
    tabs: 'IT',
  ...
  },
  {
    ...
    description: '미국 빅테크 업계 거물들이 잇따라 트럼프 취임위원회에 거액을 내놓고 있다.',
  },
  {
    tabs: '스포츠',
    title: '맨체스터 시티가 돌아왔다!',
...
export { categoryTabs, newsData, weatherData, movieData, musicData };
